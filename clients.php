		...
		<div class="span3">
			<ul class="nav nav-tabs nav-stacked">
				...
				<div class="accordion" id="accordion2">
					...
					<!-- Accordion for alphas -->
					<div class="accordion-group">
						<div class="accordion-heading">
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapse_alphas">
								A-Z
							</a>
						</div>

						<div id="collapse_alphas" class="accordion-body collapse <?php if($_GET['client']) echo "in"; ?>">
							<div class="accordion-inner">
								<ul class="nav nav-tabs nav-stacked">
									<?php foreach($alphas as $alpha) : ?>
									<li <?php if($_GET['client'] == $alpha) echo "class='active'"; ?>><a href="clients.php?client=<?php echo $alpha; ?>"><?php echo $alpha; ?></a></li>
									<?php endforeach; ?>
								</ul>
							</div>
						</div>
