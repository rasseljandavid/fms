<?php
	...
	function getInterestRates() {
		$interestRates = array("0.0", "0.05", ".07", "0.1");
	...
	function showBreadcrumbs($current_file_name, $client_id = null) {
		...
		$breadcrumbs['payments'] = array("Home" => $homelink, "Payments" => "");
		$breadcrumbs['createBatchPayment'] = array("Home" => $homelink, "Payments" => "payments.php", "Batch Payment" => "");
		$breadcrumbs['loans'] = array("Home" => $homelink, "Loans" => "");
		$breadcrumbs['clients'] = array("Home" => $homelink, "Clients" => "");
		$breadcrumbs['client'] = array("Home" => $homelink, "Clients" => "clients.php", "Client Details" => "");
		$breadcrumbs['sortClients'] = array("Home" => $homelink, "Clients" => "clients.php", "Sort Clients" => "");
